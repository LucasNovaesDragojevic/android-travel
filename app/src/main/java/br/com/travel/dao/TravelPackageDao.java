...
public class TravelPackageDao {
    ...
    static {
        ...
        travelPackageList.add(new TravelPackage("Belo Horizonte", "belo_horizonte_mg", 7, new BigDecimal("250.99")));
        travelPackageList.add(new TravelPackage("Recife", "recife_pe", 10, new BigDecimal("310")));
        travelPackageList.add(new TravelPackage("Rio de Janerio", "rio_de_janeiro_rj", 1, new BigDecimal("150")));
